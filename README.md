...
When deleting files from btdu, the displayed statistics are updated to reflect the deletion accurately. However, deleting files externally during a btdu run will skew the displayed metrics; press <kbd>⇧ Shift</kbd><kbd>R</kbd> to restart sampling and obtain fresh results.
